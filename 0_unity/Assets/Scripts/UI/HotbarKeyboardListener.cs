...
public class HotbarKeyboardListener : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        foreach (var hotbarButton in hotbarButtons)
        {
            ...
            {
                Debug.Log($"Run keyboard action {hotbarID}/{hotbarButton.Value}: {HotbarDataManager.Instance[hotbarID][hotbarButton.Value]}");
            }
        }
    }
}
